...
locals {
  github-email    = "example@gmail.com"     # you need to change this line
  github-username = "username"                # you need to change this line
  github-token    = "********"                # you need to change this line
  key_pair        = "keyname"                   # you need to change this line
  pem_key_address = "~/.ssh/keyname.pem"        # you need to change this line
